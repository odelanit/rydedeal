                                    ...
                                    @foreach($rides as $ride)
                                        <li>
                                                ...
                                                <div class="job-listing-details">
                                                    <div class="job-listing-description">
                                                        <div class="job-listing-footer">
                                                            <ul>
                                                                <li><i class="icon-material-outline-date-range"></i> Posted on {{ $ride->updated_at->format('M d, Y') }}@if($ride->completed_at)<span class="badge badge-danger margin-left-10">Completed</span>@endif</li>
                                            ...
                                            <div class="buttons-to-right always-visible">
                                                @if($ride->accepted_at)
                                                    <a href="{{ route('rides.show', ['ride' => $ride->id]) }}" class="button ripple-effect"><i class="icon-line-awesome-car"></i> Show Ride</a>
                                                    <a href="{{ route('rides.track', ['ride' => $ride->id]) }}" class="button green ripple-effect"><i class="icon-line-awesome-location-arrow"></i> Driver Location</a>
                                                @else
                                                    <a href="{{ route('rides.show', ['ride' => $ride->id]) }}" class="button ripple-effect"><i class="icon-material-outline-supervisor-account"></i> Manage Candidates <span class="button-info">{{ $ride->bids()->count() }}</span></a>
                                                    <a href="{{ route('rides.edit', ['ride' => $ride->id]) }}" class="button gray ripple-effect ico" title="Edit" data-tippy-placement="top"><i class="icon-feather-edit"></i></a>
                                                @endif
                                            </div>
                                        </li>
                                    @endforeach
