                    ...
                    <form action="{{ route('users.update', ['user' => $user]) }}" method="post">
                        ...
                        <div class="col-xl-12">
                            <div class="dashboard-box">
                                <div class="headline">
                                    <h3><i class="icon-material-outline-face"></i> User Profile</h3>
                                </div>
                                <div class="content">
                                    <ul class="fields-ul">
                                        @if($user->hasRole('driver'))
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4">
                                                        <div class="submit-field">
                                                            <h5>Car Number</h5>
                                                            <div class="attachments-container margin-top-0 margin-bottom-0">
                                                                <div class="license-box" id="plate-pic">
                                                    ...
                                                    <div class="col-xl-4">
                                                        <div class="submit-field">
                                                            <h5>Car Photo</h5>
                                                            <div class="attachments-container margin-top-0 margin-bottom-0">
                                                                <div class="license-box" id="photo-pic">
                                                                    <img class="img-fluid" src="@if($user->car){{ $user->car->photo }}@endif" alt="No Car Photo">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-4">
                                                        <div class="submit-field">
                                                            <h5>SSN</h5>
                                                            <input type="text" class="with-border" value="@if($user->car) {{ $user->car->ssn }} @endif" readonly>
                                                        </div>
                                                    </div>
                                                    @endif
                                                </div>
