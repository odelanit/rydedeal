                            ...
                            <div class="content with-padding">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4">
                                        <div class="submit-field">
                                            <h5>SSN</h5>
                                            <input class="with-border" type="text" name="ssn" value="@if($user->car){{ old('ssn', $user->car->ssn) }}@else{{ old('ssn') }}@endif">
                                        </div>
                                    </div>
                                    @endif
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xl-4">
                                        <div class="submit-field">
                                            <div class="uploadButton margin-top-15">
                                                <label id="uploadPhotoButton" class="uploadButton-button ripple-effect" data-input="photo" data-preview="photo-preview">
                                                    Upload Car Photo
                                                </label>
                                                <input type="text" id="photo" name="photo" value="@if($user->car){{ old('photo', $user->car->photo) }}@else{{ old('photo') }}@endif" hidden>
                                            </div>
                                        </div>
                                        <div id="photo-preview" class="margin-top-15">
                                            <img src="@if($user->car){{ old('photo', $user->car->photo) }}@else{{ old('photo') }}@endif" alt="Car Photo">
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $('#uploadPhotoButton').filemanager('image');
</script>
