...
{{--                                                        <div class="verified-badge"></div>--}}
                                                    ...
                                                    <div class="freelancer-name">
                                                        ...
                                                        @if($ride->completed_at && $ride->review)
                                                        <div class="freelancer-rating">
                                                            <div class="star-rating" data-rating="{{ $ride->review->rating }}"></div>
                                                        </div>
                                                        @endif
                                                        <ul class="dashboard-task-info bid-info">
                                                            <li><strong>${{ $bid->price }}</strong><span>Price</span></li>
                                                        </ul>
                                                        <div class="buttons-to-right always-visible margin-top-25 margin-bottom-5" style="display: inline-flex;">
                                                            @role('customer')
                                                            @if($bid->paid_at)
                                                                ...
                                                                @if(!$ride->completed_at)
                                                                    ...
                                                                    <form style="display: inline-flex;" action="{{ route('rides.complete', ['ride' => $ride->id]) }}" method="post">
                                                                        @csrf
                                                                        <button class="button ripple-effect green"><i class="icon-line-awesome-check"></i>Complete</button>
                                                                    </form>
                                                                @endif
                                                            @else
                                                                @if($bid->accepted_at)
