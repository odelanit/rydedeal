                                ...
                                <div class="headline-actions" style="min-width: 250px;">
                                    <form>
                                        <select class="selectpicker" name="role" id="select-role">
                                            ...
                                            @endforeach
                                            <option value="trashed" @if($query_role == 'trashed') selected @endif>Deleted Users</option>
                                        </select>
                                    </form>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap="">
                                                    @if($user->trashed())
                                                        ...
                                                        <form action="{{ route('deleted-users.destroy', ['deleted_user' => $user->id]) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                    ...
                                                    @else
                                                        ...
                                                        <form action="{{ route('users.destroy', ['user' => $user->id]) }}" method="post" style="display: inline;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="btn btn-outline-danger" type="button" data-toggle="modal" data-target="#delete-modal"><i class="icon-line-awesome-trash"></i></button>
                                                        </form>
                                                    @endif
                                                </td>
                                            </tr>
