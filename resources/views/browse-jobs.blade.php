                                ...
                                <div class="job-listing-details">
                                    ...
                                    <div class="job-listing-description">
                                        <h3 class="job-listing-title">
                                            #{{ $ride->id }} <span class="badge badge-success">Accepted Driver(s): {{ $ride->bids()->count() }}</span> @if($ride->driver_id && $ride->driver_id == auth()->user()->id) <span class="badge badge-danger">You Accepted</span> @elseif($ride->driver_id && $ride->driver_id != auth()->user()->id) <span class="badge badge-warning">Others Accepted</span> @endif
                                        </h3>
...
{{--                            @endif--}}
                        @else
                            <a href="{{ route('rides.show', ['ride' => $ride]) }}" class="job-listing">
                                <div class="job-listing-details">
                                    ...
                                    <div class="job-listing-description">
                                        <h3 class="job-listing-title">
                                            #{{ $ride->id }} <span class="badge badge-success">Accepted Driver(s): {{ $ride->bids()->count() }}</span> @if(auth()->user() && $ride->bids()->where('driver_id', auth()->user()->id)->first()) <span class="badge badge-secondary">You Accepted</span> @endif
                                        </h3>
                                        <div class="job-listing-footer">
                                            <ul>
                                                <li><i class="icon-material-outline-business"></i> {{ $ride->owner->name }}
                ...
                <div class="small-footer margin-top-15">
                    <div class="small-footer-copyrights">
                        © 2019 <strong>Rydedeal.com</strong>. All Rights Reserved.
                    </div>
