                    ...
                    @if(!$others_accepted)
                        ...
                        @else
                            <a href="#small-dialog" class="apply-now-button popup-with-zoom-anim">
                                Deal for Ryde <i class="icon-material-outline-arrow-right-alt"></i>
                            </a>
                            <a href="javascript:;" class="accept-now-button btn btn-danger" data-toggle="modal" data-target="#acceptModal">
                                Accept Ryde <i class="icon-material-outline-arrow-right-alt"></i>
                            </a>
                        @endif
                    @endif
    ...
    <div id="small-dialog" class="zoom-anim-dialog mfp-hide dialog-with-tabs">
        <div class="sign-in-form">
            <ul class="popup-tabs-nav">
                <li><a href="#tab">Deal for Ryde</a></li>
            </ul>
            <div class="popup-tabs-container">
                <div class="popup-tab-content" id="tab">
                    ...
                    <button class="button margin-top-35 full-width button-sliding-icon ripple-effect" type="submit" form="apply-now-form">Deal for Ryde <i class="icon-material-outline-arrow-right-alt"></i></button>
                </div>
            </div>
        </div>
    </div>
