...
Route::group(['middleware' => ['verified', 'verifiedphone']], function () {
    ...
    Route::group(['middleware' => ['level:1']], function () {
        ...
        Route::post('bids/accept', 'BidController@acceptFromCustomer')->name('bids.accept');
...
//    Route::resource('payment-methods', 'PaymentController');
        ...
        Route::get('payment-verify', 'StripeController@index')->name('payment-verification.index');
    ...
    Route::group(['middleware' => ['auth', 'level:2', 'settings_completed']], function () {
        ...
        Route::get('/locations/{driver}', 'DriverLocationController@show')->name('locations.show');
    });

    Route::group(['middleware' => ['role:driver']], function () {
        Route::resource('locations', 'DriverLocationController')->except(['show']);
...
//        Route::get('/rides/{id}/track', '');
    ...
    Route::group(['middleware' => ['role:customer']], function () {
        Route::post('/rides/{ride}/complete', 'RideController@complete')->name('rides.complete');
        ...
        Route::put('/payments/billing-methods/{billing_method}', 'BillingMethodController@setAsDefault')->name('billing-methods.set-as-default');
        Route::delete('/payments/billing-methods/{billing_method}', 'BillingMethodController@delete')->name('billing-methods.delete');
    });
