...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function callToVerify()
    {
        ...
        try {
            $client = new Client('AC57bed54453feec72e2ae6e844efdbd93', 'b19b1c4656aef8b60684d084e0be7293');
            $client->calls->create(
                $this->phone_number,
                "+16503000347", // REPLACE WITH YOUR TWILIO NUMBER
                ["url" => "https://rydedeal.com/build-twiml/{$code}"]
            );
    ...
    public function smsToVerify()
    {
        ...
        $client->messages->create(
            $this->phone_number,
            array(
                'body' => 'Hi, thanks for Joining to Rydedeal. Verification code: '.$this->verification_code,
                'from' => "+16503000347",
            )
        );
    }
